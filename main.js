    ...
    days: [
      {
        ...
        activities: [
          ...
          },
          {
            time: '3:00',
            name: '🚌 搭機場大巴前往涉谷',
            desc: '購買 3:15 或 3:45 班次的機場巴士，目的地：涉谷 (Shibuya)。',
            address: '',
            mapLink: '',
            notes: '',
          },
          ...
          },
          {
            ...
            desc: '5:15 避開晚高峰，前往涉谷站 Scramble Square 13F 享用知名名店「つるとんたん (TsuruTonTan)」創意大碗烏冬麵。電梯直達 13F 全程平路，麵質軟爛適合寶寶，兼具高空景色。',
        ...
        activities: [
          {
            ...
            desc: '9:15 之後搭乘地鐵銀座線前往淺草站，徹底避開地鐵通勤人潮。<br/>🎫 <strong>提示：本日有預訂傳統服飾拍照及化妝 (Klook 預訂)。</strong>',
            address: '',
            mapLink: '',
            notes: '',
          },
          ...
          },
          {
            time: '12:30',
            name: '☕ 河畔慢逛與寶寶推車小憩',
            desc: '12:30–1:45 沿隅田公園及 Mizumachi 散步至晴空塔下。路面極為平整，非常適合寶寶在推車內睡下午覺，大人可在沿岸咖啡館休整。',
          ...
          },
          {
            time: '1:45',
            name: '🚃 錯峰移動：前往原宿/明治神宮',
            desc: '1:45–2:30 乘地鐵（銀座線至表參道，約 20 分鐘一車直達）或 GO App 打車前往原宿/明治神宮，避開晚高峰。',
          ...
          },
          {
            time: '2:30',
            name: '🌿 明治神宮 (南參道入口 · 原宿口)',
            desc: '2:30–4:30 由原宿南參道入口進入（路面最平坦無台階），漫步參拜，時間充裕且採光極佳。',
          ...
          },
          {
            time: '4:30',
            name: '🛍️ 表參道/原宿區域輕鬆慢逛',
            desc: '4:30–5:30 在表參道/原宿區域輕鬆慢逛。5:30 晚高峰前 GO App 打車返回酒店或就近晚餐。',
            address: '東京都渋谷区神宮前',
          ...
          },
          {
            ...
            desc: '5:30–7:30 避開地鐵晚高峰，精選 3 家高分 (Tabelog 3.5+)、空間寬敞、對推車與寶寶極友善的餐廳：',
            address: '',
            mapLink: '',
            notes: '',
            options: [
              ...
              },
              {
                ...
                desc: '位於表參道巷內，由舊錢湯改建的歷史名店。空間寬敞且設有包廂/和室，提供軟爛蒸蛋與嬰兒餐具，推車出入方便。<br/>⚠️ <strong>預約需求：建議提前預訂二樓包廂或 5:30 錯峰用餐。</strong>',
      ...
      // ── Day 4 ──────────────────────────────────────────────
      {
        ...
        activities: [
          ...
          },
          {
            ...
            desc: '1:15–2:30 參拜觀賞露天青銅大佛，隨後步行 5 分鐘前往長谷寺 (Hasedera)（推車停門口，換背帶登階梯俯瞰相模灣海景）。',
          ...
          },
          {
            ...
            highlight: {
              ...
              tip: '💡 請勿站在車道上拍照，注意避讓交通。下午 3:00–4:00 順光海景拍照最藍！',
            },
          },
          {
            time: '4:10',
          ...
          },
          {
            ...
            desc: '6:15 返抵涉谷 Hyatt House 徹底休息蓄能，準備明天 (Day 5) 全家行李大轉運飛往北海道。',
      ...
      // ── Day 7 ──────────────────────────────────────────────
      {
        ...
        activities: [
          ...
          },
          {
            time: '1:30',
            name: '🤝 小樽匯合與停車方案',
            desc: '1:30 Te A 乘 JR 返回小樽站，與 Te B 匯合。Alphard 停放於運河周邊大型露天 Times 停車場。',
            address: '',
            mapLink: '',
            notes: '',
            options: [
...
/** 將 24 小時制時間字串轉為 12 小時制（不含/，例如 "17:30" -> "5:30", "08:30" -> "8:30"） */
function formatTime12h(str) {
  if (!str) return '';
  let s = str.replace(/\s*(?:|)\b/gi, '');
