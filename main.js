        ...
        activities: [
          {
            ...
            desc: '準時於 09:15 之後，從「涉谷站」搭乘 JR 湘南新宿線 (往逗子方向)，一車直達「鎌倉站」（僅需 52 分鐘，無需換乘）。',
            address: 'JR 涉谷站',
            mapLink: 'https://maps.google.com/?q=Shibuya+Station',
            notes: '🎒 裝備提示：本日長谷寺台階路較多，建議攜帶嬰兒推車 + 背帶配合使用。避開通勤高峰後車廂寬敞。',
          },
          {
            time: '10:15',
          ...
          },
          {
            ...
            notes: '🍱 提示：選擇榻榻米包廂/卡座，方便寶寶脫鞋爬行休整。',
          },
          {
            time: '13:00',
            name: '🚕 🚊 極效移動：打車避暑 或 體驗江之電',
            desc: '於鎌倉站可選擇直接叫計程車 (Taxi，約 10 分鐘 / 1,500 日元直達高德院門前避暑)，或搭乘「江之電」至「長谷站」（3 站約 6 分鐘）後步行 7 分鐘直達高德院 (鎌倉大佛)。',
            address: '神奈川県鎌倉市長谷 4-2-28 (高德院)',
            mapLink: 'https://maps.google.com/?q=Kotoku-in+Kamakura+Daibutsu',
            notes: '🚕 帶娃打車直達門前可節省體力避開午後炎熱。',
          },
          {
            time: '13:15',
            name: '🗿 鎌倉大佛 (高德院) 與 長谷寺海景',
            desc: '13:15–14:30 參拜觀賞恢宏的露天青銅大佛，隨後步行 5 分鐘前往長谷寺 (Hasedera)。推車停放於寺門，換背帶登階梯遊覽地藏庭園並俯瞰由比濱海景。',
            address: '神奈川県鎌倉市長谷 3-11-2 (長谷寺)',
            mapLink: 'https://maps.google.com/?q=Hasedera+Temple+Kamakura',
            notes: '🎒 提示：長谷寺登頂見海景有較多石階，推車需寄放在寺門口，換背帶輕鬆登高。',
            highlight: {
              emoji: '🗿',
              title: '鎌倉大佛与長谷寺',
          ...
          },
          {
            time: '14:45',
            name: '🚃 江之電經典海岸線移動',
            desc: '於長谷站搭乘「江之電」電車（4 站約 10 分鐘）直達 鎌倉高校前站 (Kamakura Koukou-Mae)。',
            address: '江之電 長谷站',
            mapLink: 'https://maps.google.com/?q=Hase+Station+Enoden',
            notes: '江之電沿海行駛，沿途海景極具復古風情。',
          },
          {
            time: '15:00',
            name: '🏀 灌籃高手平交道與湘南海岸打卡',
            desc: '15:00–15:45 遊覽《灌籃高手》經典海濱平交道與湘南海岸風光，拍照打卡。',
            address: '神奈川県鎌倉市腰越 1-1（鎌倉高校前平交道）',
            mapLink: 'https://maps.google.com/?q=Kamakura-kokomae+Station',
            notes: '📸 拍照提示：平交道旁有路口行人指示，請在安全區域等候綠色江之電電車駛過打卡，注意安全。',
            highlight: {
              emoji: '🏀',
          ...
          {
            time: '15:45',
            name: '🚃 順路返程不走回頭路 (江之電 → 藤澤)',
            desc: '順路繼續搭乘江之電前往終點 藤澤站 (Fujisawa)（約 16 分鐘）。',
            address: '江之電 藤澤站',
            mapLink: 'https://maps.google.com/?q=Fujisawa+Station',
            notes: '不走回頭路，順向搭完江之電全線至藤澤轉乘 JR 返回東京。',
          },
          {
            time: '16:15',
            name: '🚆 藤澤站無縫換乘 JR 直達涉谷',
            desc: '從藤澤站無縫換乘 JR 湘南新宿線（約 46 分鐘，一車直達）返回涉谷站。',
            address: 'JR 藤澤站',
            mapLink: 'https://maps.google.com/?q=Fujisawa+Station+JR',
            notes: '46 分鐘直達，車廂空曠，全家可在車上休整休息。',
          },
          {
            time: '17:15',
            name: '🏨 返抵涉谷 Hyatt House 休息蓄能',
            desc: '17:15 返抵涉谷 Hyatt House 徹底休息蓄能，準備明天 (Day 5) 全家行李大轉運飛往北海道。',
            address: '東京都渋谷区桜丘町 1-4（Hyatt House Tokyo Shibuya）',
            mapLink: 'https://maps.google.com/?q=Hyatt+House+Tokyo+Shibuya',
            notes: '晚上早點休息，整理明天飛北海道行李！',
          },
        ],
      },
    ],
