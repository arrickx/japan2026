  ...
  // ============================================================
  {
    ...
    days: [
      ...
      // ── Day 8 ──────────────────────────────────────────────
      {
        date: '9/7',
        dayNum: 'Day 8',
        title: '北海道神宮禪意與札幌場外市場頂級海鮮宴',
        summary: 'Komeda卡座早餐/休息、円山公園与神宮散步、場外市場海鮮大餐、狸小路漫步与特調拿鐵',
        illustration: './images/sapporo.jpg',
        hotel: { name: 'FAV LUX 札幌', mapLink: 'https://maps.google.com/?q=FAV+LUX+Sapporo' },
        ...
        activities: [
          ...
          {
            time: '11:15',
            name: '🦀 11:15 札幌場外市場海鮮大餐',
            desc: '驅車 8 分鐘直達 札幌場外市場 (Sapporo Outer Market)。利用露天超大停車場方便停放 Alphard。在寬敞卡座餐廳（如「北之漁場」或「食堂北之美食」）享用現蒸帝王蟹、毛蟹及頂級平價海鮮丼。',
            address: '北海道札幌市中央区北11条西21丁目',
            mapLink: 'https://maps.google.com/?q=Sapporo+Outer+Market',
            notes: '明碼標價、品質極高、絕無宰客拉客陷阱，卡座寬敞對推車与寶寶極友善。',
          },
          {
            time: '13:00',
            name: '🚗 返回酒店停放車輛',
          ...
          },
          {
            ...
            desc: '全員從酒店步行 3–5 分鐘無縫接入狸小路商店街与地下街 (Pole Town / Aurora Town) 慢逛採購。順路前往附近的 Baristart Coffee 外帶自選北海道牧場鮮奶特調拿鐵，推著推車邊走邊喝。',
