...
const ITINERARY = [
  {
    ...
    days: [
      ...
      // ── Day 4 ──────────────────────────────────────────────
      {
        date: '9/3',
        dayNum: 'Day 4',
        title: '橫濱全天親子遊 (AIR CABIN 纜車與海濱公園)',
        summary: '麵包超人博物館・YOKOHAMA AIR CABIN 纜車・紅磚倉庫海濱公園・錯峰返回涉谷',
        ...
        activities: [
          {
            time: '09:15',
            name: '🚃 极其絲滑的通勤 (東急東橫線)',
            desc: '準時於 09:15 之後，從涉谷站直接搭乘「東急東橫線 (直通港未來線)」。此線路無需換乘，從涉谷一車直達橫濱港未來區域，對推車家庭極其友好。',
            address: '',
            mapLink: '',
            notes: '避開通勤高峰後車廂寬敞，推車全程免折疊上車。',
          },
          {
            time: '10:30',
            name: '🍞 橫濱麵包超人兒童博物館',
            desc: '抵達橫濱麵包超人兒童博物館 (Yokohama Anpanman Children’s Museum)，適合帶小寶寶的親子互動。',
          ...
          },
          {
            time: '11:15',
            name: '🍽️ 11:15 館內錯峰餐',
            desc: '提前在 11:15 前往館內主題餐廳用餐，避開中午搶位高峰。',
          ...
          {
            time: '15:30',
            name: '🚡 YOKOHAMA AIR CABIN 纜車 + 紅磚倉庫海濱公園',
            desc: '週四摩天輪定休替代方案：<br/>' +
                  '🚡 <strong>YOKOHAMA AIR CABIN 空中纜車</strong>：週四正常營業。全無障礙設計，嬰兒推車無需折疊即可直接推入車廂。從櫻木町直達運河公園，高空俯瞰橫濱港全景，體驗感極佳。<br/>' +
                  '🧱 <strong>紅磚倉庫與赤磚海濱公園 (Aka-Renga Park)</strong>：出纜車站即達。擁有超大無障礙沿海草坪，極其適合 1 歲寶寶安全走路放電，大人可在沿海咖啡廳（如 Bills）享用下午茶觀賞海景。',
            address: '神奈川県横浜市中区新港 2-1-2 (運河公園站)',
            mapLink: 'https://maps.google.com/?q=YOKOHAMA+AIR+CABIN+Ungapark+Station',
            notes: '👶 全程無障礙友好，推車完全不用折疊！海濱草坪非常適合寶寶平地放電。',
            highlight: {
              emoji: '🚡',
              title: 'YOKOHAMA AIR CABIN 空中纜車',
              tags: ['城市都市纜車', '無障礙景觀', '推車直入', '橫濱港全景'],
              intro: '日本首座都市型高空索道纜車，連接 JR 櫻木町站與新港運河公園。車廂全玻璃透明視野，全無障礙設計，推車完全無需折疊即可直接推入。',
              must: [
                '高空俯瞰港未來 21 全景 — 摩天輪、港灣大橋、紅磚倉庫一覽無遺',
                '櫻木町 ⇄ 運河公園單程 5 分鐘 — 完美避開步道路程，快速抵達紅磚倉庫',
                '夜間燈光秀 — 傍晚車廂與纜車索道均有燈光藝術，浪漫氣氛滿分',
              ],
              tip: '💡 完美替代週四定休的摩天輪！全無障礙推車免收折，單程票約 ¥1,000。',
            },
          },
          {
            time: '17:30',
            name: '🍜 17:30–19:30 晚高峰物理規避',
            desc: '不在此期間帶娃推車搭乘地鐵回東京。安排在港未來/紅磚倉庫周邊享用晚餐並散步。',
            address: '港未來 / 紅磚倉庫周邊',
            mapLink: 'https://maps.google.com/?q=Yokohama+Red+Brick+Warehouse',
            notes: '海邊夕陽極美，周邊餐廳均有寬敞卡座与推車通道。',
          },
          {
            time: '19:45',
            name: '🚃 錯峰乘車返回涉谷',
            desc: '於 19:45 晚高峰基本散去後，搭乘直達電車返回涉谷。',
            address: '',
            mapLink: '',
      ...
      // ── Day 15 ─────────────────────────────────────────────
      {
        ...
        activities: [
          ...
          },
          {
            ...
            notes: '11:15 剛開門入座無須排隊，推車可輕鬆進入，品質極高。',
          },
          {
            time: '13:30',
            name: '🛍️ 下午：集中購物日',
            ...
            notes: '🛍️ 零負擔購物：隨買隨送回酒店，推車完全不佔空間。',
          },
          {
            time: '18:00',
            name: '🍽️ 傍晚：銀座漫步與優雅晚餐',
            ...
            notes: '銀座夜景璀璨，餐廳選擇豐富，適合全家悠閒享受晚餐。',
          },
        ],
      },
      // ── Day 16 ─────────────────────────────────────────────
